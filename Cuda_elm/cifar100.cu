...
int main()
{
	...
	unsigned long ip_num  = 256	;
	unsigned long op_num = 100;
	unsigned long hid_num = 200	;
	...
	Import_Fromfile(X_Train,"features_cifar100/train_features.csv");
	Import_Fromfile(Y_Train,"features_cifar100/train_labels.csv");
	Import_Fromfile(X_Test,"features_cifar100/test_features.csv");
	Import_Fromfile(Y_Test,"features_cifar100/test_labels.csv");
